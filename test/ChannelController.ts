...
describe('ChannelController', () => {
    ...
    beforeEach(() => {
        ...
        l1 = new Lamp(1, "l1", cc);
        l2 = new Lamp(2, "l2", cc);
        l3 = new Lamp(3, "l3", cc, 5);
        l4 = new Lamp(8, "l4", cc, 2);
        d1 = new Lamp(1, "d1", cc, 2);
    });
    ...
    describe("w lamps", () => {
        ...
        describe("update lamps", () => {
            ...
            it("update lamp multi channel", () => {
                l4.value = [50, 50];
                let x = cc.generateChannelValues(true);
                assert.deepStrictEqual(x, [0,0,0,0,0,0,0,50,50]);
            })
            it("update lamp multi channel in middle", () => {
                l3.value = [10, 20, 30, 40, 50];
                let x = cc.generateChannelValues(true);
                assert.deepStrictEqual(x, [0,0,10,20,30,40,50,0,0]);
            })
